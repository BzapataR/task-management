...
import { Box, Drawer, Paper, Typography, Button, Snackbar, Alert, Stack, IconButton, alpha } from "@mui/material";
...
import { getEventsFromStorage, saveEventsToStorage, getEventsForDate, formatDateHeader, sortEventsByStartTime } from "../utils/eventStorage";
  ...
  return (
    <Providers>
      <div className="min-h-screen bg-[#121212]">
        <Header title="Event Dashboard" onMenuClick={handleDrawerToggle} onAddClick={handleAddEvent} />
        ...
        >
          <Stack direction={{ xs: "column", md: "row" }} spacing={3}>
            ...
            >
              <CalendarView selectedDate={selectedDate} onDateChange={handleDateChange} events={events} />
              ...
              >
                <UpcomingEvents events={events} onAddEvent={handleAddEvent} onSelectEvent={handleSelectEvent} />
              </Box>
            </Box>
                ...
                {selectedDateEvents.length === 0 ? (
                  ...
                  >
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                      There are no events scheduled for this date. Would you like to create a new event?
                    </Typography>
                    <Button variant="contained" startIcon={<Add />} onClick={handleAddEvent}>
                      Create Event
                    </Button>
