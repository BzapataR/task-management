...
import { eventColors } from "../app/utils/eventStorage";
...
const EventForm = ({
    ...
    const [startTime, setStartTime] = useState(
        event?.startTime || dayjs().hour(9).minute(0).second(0)
    );
    const [endTime, setEndTime] = useState(
        event?.endTime || dayjs().hour(10).minute(0).second(0)
    );
